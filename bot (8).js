...
const { connectDB, User, Trade, Alert, Lesson, Feedback, MarketCache } = require('./database');
...
const { formatWelcome, formatScan, formatAnalysis, formatChartAnalysis, formatTrade, formatPortfolioSnapshot, formatPerformanceStats, formatStrategy, formatHelp, MAIN_KEYBOARD, safe, fmtPrice } = require('./formatters');
const logger = { info: (...a) => console.log(new Date().toISOString().slice(11,19), '[INFO]', ...a), warn: (...a) => console.warn('[WARN]', ...a), error: (...a) => console.error('[ERROR]', ...a), debug: (...a) => {} };
